(module
 ...
 (memory $0 1)
 (data (i32.const 8) "\0c")
 (data (i32.const 40) "\08\00\00\00\03")
 (data (i32.const 48) "\0d\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s")
 (data (i32.const 80) "\1c\00\00\00~\00l\00i\00b\00/\00i\00n\00t\00e\00r\00n\00a\00l\00/\00a\00r\00r\00a\00y\00b\00u\00f\00f\00e\00r\00.\00t\00s")
 (data (i32.const 144) "\08")
 (data (i32.const 156) "\08")
 (data (i32.const 160) "\90\00\00\00\02")
 ...
 (func $~lib/internal/arraybuffer/reallocateUnsafe (; 7 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/array/Array<i32>#__set (; 8 ;) (; has Stack IR ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  ;;@ ~lib/array.ts:85:4
  (if
   ;;@ ~lib/array.ts:85:8
 ...
 (func $~lib/array/Array<i32>#__get (; 9 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  ;;@ ~lib/array.ts:73:23
  (if (result i32)
   ;;@ ~lib/array.ts:71:11
 ...
 (func $assembly/index/posit (; 10 ;) (; has Stack IR ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
