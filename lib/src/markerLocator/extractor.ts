...
function squareToQuadrilateral(p1: Point, p2: Point, p3: Point, p4: Point): IPerspectiveTransform {
...
function quadrilateralToSquare(p1: Point, p2: Point, p3: Point, p4: Point): IPerspectiveTransform {
