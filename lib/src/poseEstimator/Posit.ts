/*
Based on work by Juan Mellado in https://github.com/jcmellado/js-aruco/blob/master/src/posit2.js
...
export class Posit {
    private modelVectors;
    private model;
    private modelPseudoInverse;
    private modelNormal;
    private focalLength;
    ...
    private pos(points, eps, rotation1, rotation2, translation1, translation2) {
    ...
    private iterate(points, rotation, translation) {
    ...
    private getError(points, rotation, translation) {
